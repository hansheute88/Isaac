...
1. GitHub-Account mit Zugriff auf **hansheute88/isaac** (preferred; legacy: sc0rp0815/Isaac)
...
2. GitHub verbinden, Repo wählen: **hansheute88/isaac**
...
1. **New +** → **Web Service**
2. Repo **hansheute88/isaac**, Branch wie oben
3. Runtime: **Docker**
